...
public interface MicroListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterDecl_list(MicroParser.Decl_listContext ctx);
	/**
	 * Exit a parse tree produced by {@link MicroParser#decl_list}.
	 * @param ctx the parse tree
	 */
	void exitDecl_list(MicroParser.Decl_listContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterString_decl_list(MicroParser.String_decl_listContext ctx);
	/**
	 * Exit a parse tree produced by {@link MicroParser#string_decl_list}.
	 * @param ctx the parse tree
	 */
	void exitString_decl_list(MicroParser.String_decl_listContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterVar_decl_list(MicroParser.Var_decl_listContext ctx);
	/**
	 * Exit a parse tree produced by {@link MicroParser#var_decl_list}.
	 * @param ctx the parse tree
	 */
	void exitVar_decl_list(MicroParser.Var_decl_listContext ctx);
	/**
